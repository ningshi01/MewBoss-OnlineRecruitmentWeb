...
let mes = useMessage()
const emit = defineEmits(['feature_like', 'post_comment', 'follow_it', 'Unfollow_it'])
...
function updateDatas() {
  ...
  if (checkLogin()) {
    ...
    datas.flag_like = props.likers_list.find((liker) => liker.id === datas.now_userID)
  }
  ...
  <div class="card-container">
    <n-page-header class="card-item">
      ...
      <template #extra>
        ...
        <n-space v-if="datas.isMe">
          <n-button :bordered="false" size="large" @click.stop="deleteMoment">
            <template #icon>
              <n-icon>
                <svg
